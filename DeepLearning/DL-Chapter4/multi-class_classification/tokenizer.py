    ...
    def tokenize(self, sequence):
        ...
        for word in sequence.lower().split():
            ...
            if punc_check:
                ...
                token_punc = next((token for token, value in self.word_index.items() if ''.join(punc_check) == value), None)
